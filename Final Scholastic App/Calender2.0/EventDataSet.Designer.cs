...
namespace Calender2._0 {
    ...
    public partial class EventDataSet : global::System.Data.DataSet {
        ...
        public partial class EventDataTable : global::System.Data.TypedTableBase<EventRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EventRow AddEventRow(string _event) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EventRow FindByDate(int Date) {
        ...
        public partial class EventRow : global::System.Data.DataRow {
            ...
            public int Date {
                get {
                    return ((int)(this[this.tableEvent.DateColumn]));
                }
                set {
...
namespace Calender2._0.EventDataSetTableAdapters {
    ...
    public partial class EventTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Event] WHERE (([Date] = @Original_Date) AND ([event] = @Origin" +
                "al_event))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Event] ([event]) VALUES (@event);\r\nSELECT Date, event FROM Eve" +
                "nt WHERE (Date = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Event] SET [event] = @event WHERE (([Date] = @Original_Date) AND ([" +
                "event] = @Original_event));\r\nSELECT Date, event FROM Event WHERE (Date = @Date)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Date", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Date", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Calender2._0.Properties.Settings.Default.EventListConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Date, event FROM dbo.Event";
        ...
        public virtual int Fill(EventDataSet.EventDataTable dataTable) {
        ...
        public virtual EventDataSet.EventDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EventDataSet.EventDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Date, string Original_event) {
        ...
        public virtual int Insert(string _event) {
            if ((_event == null)) {
        ...
        public virtual int Update(string _event, int Original_Date, string Original_event, int Date) {
            if ((_event == null)) {
                throw new global::System.ArgumentNullException("_event");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_Date));
            if ((Original_event == null)) {
                throw new global::System.ArgumentNullException("Original_event");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_event));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string _event, int Original_Date, string Original_event) {
            return this.Update(_event, Original_Date, Original_event, Original_Date);
        }
    }
